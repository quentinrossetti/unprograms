...
-- inheritance, metamethods and a basic support for mixins.
-- - [Homepage](https://yonaba.github.io/30log/)
-- - [Documentation](https://github.com/Yonaba/30log/wiki)
-- @module 30log
-- @license MIT
-- @copyright 2020 2012-2016 Roland Yonaba <roland.yonaba@gmail.com>
