------------
-- 30log, in extenso 30 Lines Of Goodness is a minified framework for 
-- object-orientation in Lua. It provides named and unnamed classes, single 
-- inheritance, metamethods and a basic support for mixins. In 30 lines. Well, 
-- somehow.
--
--  - [Homepage](http://yonaba.github.io/30log/)
--  - [Repackaged for OpenComputers by Quentin Rossetti](https://quentinrossetti.github.io/libun)
-- @module 30log
-- @license MIT 
-- @copyright 2012-2016 Roland Yonaba <roland.yonaba@gmail.com>
